...
public class Canada extends Main{	
	private JPanel topPanel;
    private JTextPane tPane;
    private int total_num = 3759;
    
    public Canada(int population, int people)
    {		    
    	topPanel = new JPanel();       
        ...
        tPane.setBounds(170,121,140, 80);
	    topPanel.add(tPane);
        Font f = new Font("Arial Bold",Font.BOLD|Font.ITALIC,12);
        tPane.setFont(f);
        appendToPane(tPane, String.format("Canada%n%n"  ), Color.RED);
