...
public class Ethiopia extends Main {
	private JPanel topPanel;
    private JTextPane tPane;
    private int total_num = 10986;
    
    public Ethiopia(int population, int people)
    {		    
    	topPanel = new JPanel();       
        ...
        tPane.setBounds(300,400,100, 100);
	    topPanel.add(tPane);
        Font f = new Font("Arial Bold",Font.BOLD|Font.ITALIC,12);
        tPane.setFont(f);
        appendToPane(tPane, String.format("Ethiopia%n%n"  ), Color.RED);
