...
public class Japan extends Main {
	private JPanel topPanel;
    private JTextPane tPane;
    private int total_num = 12230;
    
    public Japan(int population, int people)
    {		    
    	topPanel = new JPanel();       
        ...
        tPane.setBounds(730,100,100, 160);
	    topPanel.add(tPane);
        Font f = new Font("Arial Bold",Font.BOLD|Font.ITALIC,12);
        tPane.setFont(f);
        appendToPane(tPane, String.format("Japan%n%n"  ), Color.RED);
