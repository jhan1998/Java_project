...
public class Taiwan extends Main {
	private JPanel topPanel;
    private JTextPane tPane;
    private int total_num = 2360;
    
    public Taiwan(int population, int people)
    {		    
    	topPanel = new JPanel();       
        ...
        tPane.setBounds(660,400,120, 60);
	    topPanel.add(tPane);
        Font f = new Font("Arial Bold",Font.BOLD|Font.ITALIC,12);
        tPane.setFont(f);
        appendToPane(tPane, String.format("Taiwan%n%n"  ), Color.RED);
