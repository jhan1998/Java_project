...
public class America extends Main {
	private JPanel topPanel;
    private JTextPane tPane;
    private int total_num = 32973;
    
    public America(int population, int people)
    {		    
    	topPanel = new JPanel();       
        ...
        tPane.setBounds(170,200,140, 80);
	    topPanel.add(tPane);
        Font f = new Font("Arial Bold",Font.BOLD|Font.ITALIC,12);
        tPane.setFont(f);
        appendToPane(tPane, String.format("America%n%n"  ), Color.RED);
    ...
    public void set_color(int p) {
    	System.out.println(p);
    	tPane.setBackground(new Color(255 - 255*(p/total_num), 255, 255 - 225*(p/total_num)));
    }
}
