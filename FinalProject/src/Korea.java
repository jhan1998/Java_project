...
public class Korea extends Main {
	private JPanel topPanel;
    private JTextPane tPane;
    private int total_num = 5164;
    
    public Korea(int population, int people)
    {		    
    	topPanel = new JPanel();       
        ...
        tPane.setBounds(640,200,90, 60);
	    topPanel.add(tPane);
        Font f = new Font("Arial Bold",Font.BOLD|Font.ITALIC,12);
        tPane.setFont(f);
        appendToPane(tPane, String.format("Korea %n%n" ), Color.RED);
